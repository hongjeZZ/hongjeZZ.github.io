...
MongoDB를 사용하기 위해 **spring-boot-starter-data-mongodb** 의존성을 추가했습니다. Spring Data MongoDB의 핵심 기능을 제공하며, MongoDB와의 연동을 쉽게 구현할 수 있도록 도와줍니다.
...
- *Spring Data MongoDB* 는 *org.springframework.data.mongodb* 라이브러리의 *@Query* 어노테이션을 통해 쿼리 메서드를 지원합니다.
  ...
  - 자세한 내용은 [스프링 몽고디비 공식문서](https://docs.spring.io/spring-data/mongodb/reference/mongodb/repositories/query-methods.html)를 참고해 주세요!
...
[🔗 GitHub - bwaldvogel/mongo-java-server](https://github.com/bwaldvogel/mongo-java-server)
...
[🔗 Spring boot with MongoDB - Spring Data MongoDB를 사용해보자 (khdscor.tistory.com)](https://khdscor.tistory.com/115)

[🔗 [Spring] Embedded MongoDB! 통합테스트를 위한 인메모리 몽고디비 설정하기 (thalals.tistory.com)](https://thalals.tistory.com/466)

[🔗 MongoDB-specific Query Methods :: Spring Data MongoDB (docs.spring.io)](https://docs.spring.io/spring-data/mongodb/reference/mongodb/repositories/query-methods.html)
